...
namespace TransferbuttonMenu
{
    ...
    public static class SellAllPatch
    {
        ...
        private static string GetSellDamagedText(TransferbuttonMenuSettings settings)
        {
            if (settings != null)
            {
        ...
        private static string GetSellDamagedHint(TransferbuttonMenuSettings settings)
        {
            if (settings != null)
            {
                var threshold = settings.GetEffectiveDamageThreshold();
        ...
        private static string GetSellLowValueText(TransferbuttonMenuSettings settings)
        {
            if (settings != null)
            {
        ...
        private static string GetSellLowValueHint(TransferbuttonMenuSettings settings)
        {
            if (settings != null)
            {
