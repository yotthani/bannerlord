...
namespace TransferbuttonMenu
{
    ...
    public class InventoryQuickActionsLogic
    {
        ...
        public void ExecuteSellAllDamaged()
        {
            try
            {
                var settings = TransferbuttonMenuSettings.Get();
        ...
        private List<SPItemVM> GetDamagedItems(TransferbuttonMenuSettings settings)
        {
        ...
        private List<SPItemVM> GetLowValueItems(TransferbuttonMenuSettings settings)
        {
        ...
        private bool IsDamagedItem(SPItemVM itemVM, float threshold, TransferbuttonMenuSettings settings)
        {
            try
            {
        ...
        private bool IsLowValueItem(SPItemVM itemVM, int threshold, TransferbuttonMenuSettings settings)
        {
            try
            {
                var itemObject = GetItemObject(itemVM);
        ...
        {
            if (TransferbuttonMenuSettings.Get()?.PlaySounds != true) return;
