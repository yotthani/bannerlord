...
namespace TransferbuttonMenu
{
    ...
    public class InventorySearchBehavior : CampaignBehaviorBase
    {
        ...
        public override void SyncData(IDataStore dataStore)
        {
            ...
            {
                TransferbuttonMenuLog.Error(FEATURE_NAME, "SyncData error", ex);
            }
        }
        ...
        public void OnTick()
        {
            ...
            {
                TransferbuttonMenuLog.Debug(FEATURE_NAME, $"Tick error: {ex.Message}");
            }
        }
        ...
        private bool IsFeatureEnabled()
        {
            try
            {
                return TransferbuttonMenuSettings.Get().EnableInventorySearch;
            }
            catch
            {
