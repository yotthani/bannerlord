...
namespace LayeredArmor
{
    public class LayeredArmorVM : ViewModel
    {
        ...
        private readonly MBBindingList<ArmorSlotVM> _innerSlots;
        private readonly MBBindingList<ArmorSlotVM> _middleSlots;
        private readonly MBBindingList<ArmorSlotVM> _outerSlots;
        ...
        private static void AddSlots(MBBindingList<ArmorSlotVM> list, ArmorLayerData data, ArmorLayer layer)
        {
    ...
    public class ArmorSlotVM : ViewModel
    {
        ...
        private readonly ArmorLayer _layer;
