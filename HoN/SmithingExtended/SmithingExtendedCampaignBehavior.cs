...
namespace SmithingExtended
{
    ...
    public class SmithingExtendedCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private void OnSessionLaunched(CampaignGameStarter starter)
        {
            ...
            if (!IsEnabled)
            {
                SmithingExtendedLog.Debug($"{FEATURE_NAME} is disabled in settings.");
                return;
            }
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "NewGame", () =>
            {
                _uniqueItems = new Dictionary<string, HoNUniqueItemData>();
                _totalItemsCrafted = 0;
                _totalUniquesCrafted = 0;
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "TrackCrafted", () =>
            {
                _totalItemsCrafted++;
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "TrackRepair", () =>
            {
                _totalRepairs++;
            });
        }
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "RegisterUnique", () =>
            {
