...
namespace SmithingExtended
{
    ...
    public static class SmithingExtendedPatches
    {
        ...
        public static bool IsEnabled
        {
            get
            {
                try { return SmithingExtendedSettings.Get().EnableSmithingExtended; }
                catch { return true; }
            }
        }
        ...
        public static void GetMaxHeroCraftingStamina_Postfix(Hero hero, ref int __result)
        {
            try
            {
                ...
                var settings = SmithingExtendedSettings.Get();
            ...
            {
                SmithingExtendedLog.Debug($"[SmithingExtended] GetMaxHeroCraftingStamina error: {ex.Message}");
            }
        }
        ...
        public static void DailyTickHero_Postfix(Hero hero, CraftingCampaignBehavior __instance)
        {
            ...
            {
                SmithingExtendedLog.Debug($"[SmithingExtended] DailyTickHero error: {ex.Message}");
            }
        }
        */
        ...
        public static void DoSmelting_Prefix(Hero hero, CraftingCampaignBehavior __instance)
        {
            ...
            {
                SmithingExtendedLog.Debug($"[SmithingExtended] DoSmelting error: {ex.Message}");
            }
        }
        */
        ...
        public static void DoRefinement_Prefix(Hero hero, CraftingCampaignBehavior __instance)
        {
            ...
            {
                SmithingExtendedLog.Debug($"[SmithingExtended] DoRefinement error: {ex.Message}");
            }
        }
        /// </summary>
        ...
        public static bool SetHeroCraftingStamina_Prefix(Hero hero, int value, ref int ____currentHeroCraftingStamina)
        {
            ...
            {
                SmithingExtendedLog.Debug($"[SmithingExtended] SetStamina error: {ex.Message}");
                return true;
            }
        }
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "CraftedWeapon", () =>
            {
                if (!IsEnabled) return;
    ...
    public static class SettlementMenuExtension
    {
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "RegisterMenus", () =>
            {
                var settings = SmithingExtendedSettings.Get();
                ...
                starter.AddGameMenuOption(
                    ...
                    args =>
                    {
                        SafeExec.Execute(FEATURE_NAME, "OpenRepairMenu", () =>
                        {
                ...
                starter.AddGameMenuOption(
                    ...
                    args =>
                    {
                        SafeExec.Execute(FEATURE_NAME, "ViewRepairItems", OpenRepairScreen);
                    },
                    false,
                    0);
                ...
                starter.AddGameMenuOption(
                    ...
                    args =>
                    {
                        SafeExec.Execute(FEATURE_NAME, "LeaveRepair", () =>
                        {
                ...
                SmithingExtendedLog.Debug($"[{FEATURE_NAME}] Repair shop menu registered.");
            });
        }
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "ShowRepairInquiry", () =>
            {
                ...
                foreach (var item in repairableItems.Take(10))
                {
                    ...
                    if (options.Count > 0)
                    {
                        ...
                        if (firstOption != null)
                        {
                            int finalCost = (int)(firstOption.GoldCost * SmithingExtendedSettings.Get().RepairCostMultiplier);
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "ExecuteRepair", () =>
            {
                int finalCost = (int)(option.GoldCost * SmithingExtendedSettings.Get().RepairCostMultiplier);
        ...
        private static List<EquipmentElement> GetRepairableItems()
        {
            ...
            SafeExec.Execute(FEATURE_NAME, "GetRepairableItems", () =>
            {
