...
namespace FiefManagement
{
    ...
    public class FiefManagementNavigationElement
    {
        ...
        public bool IsEnabled
        {
            get
            {
                try { return FiefManagementSettings.Get().EnableFiefManagement; }
                catch { return true; }
            }
        }
        ...
        public void OnClick()
        {
            SafeExec.Execute(FEATURE_NAME, "OnClick", () =>
            {
                if (!IsEnabled) return;
    ...
    public static class FiefManagementMapBarPatches
    {
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "Constructor", () =>
            {
                if (!IsEnabled) return;
        ...
        */
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "Update", () =>
            {
                if (!IsEnabled) return;
    ...
    public class FiefManagementNavItemVM : ViewModel
    {
        ...
        public FiefManagementNavItemVM()
        {
            ...
            {
                FiefManagementLog.Error(FEATURE_NAME, "NavItemVM Constructor", ex);
            }
        }
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "ExecuteAction", () =>
            {
                if (FiefManagementHelper.CanOpenFiefManagement())
                {
                    FiefManagementHelper.OpenFiefManagement();
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "RefreshState", () =>
            {
                IsEnabled = FiefManagementHelper.CanOpenFiefManagement();
            });
        }
    ...
    public static class FiefManagementHelper
    {
        ...
        {
            SafeExec.Execute(FEATURE_NAME, "OpenScreen", () =>
            {
        ...
        public static System.Collections.Generic.List<Settlement> GetPlayerFiefs()
        {
            ...
            SafeExec.Execute(FEATURE_NAME, "GetFiefs", () =>
            {
                var playerClan = Clan.PlayerClan;
