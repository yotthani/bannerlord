...
namespace MixedFormations
{
    public class FormationLayoutVM : ViewModel
    {
        ...
        private readonly MixedFormationLayoutBehavior _behavior;
        private readonly MBBindingList<LayoutOptionVM> _layoutOptions;
    ...
    {
        private readonly FormationLayoutType _type;
        private readonly string _name;
        private readonly FormationLayoutVM _parent;
